...
suite('Telemetry - common properties', function () {
	...
	test('default', function () {
		const props = resolveWorkbenchCommonProperties(testStorageService, undefined!, { remoteAuthority: undefined } as unknown as IWorkbenchEnvironmentService, release(), hostname(), 'someMachineId', 'someSqmId', 'somedevDeviceId', false, process);
