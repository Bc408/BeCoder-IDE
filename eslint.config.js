...
export default defineConfig(
	...
	{
		files: [
			'src/vs/workbench/browser/parts/editor/becoder*.ts',
			'src/vs/workbench/contrib/becoder/**/*.ts',
			'src/vs/workbench/test/browser/parts/editor/becoder*.ts',
			'src/vs/workbench/test/browser/parts/becoder/**/*.ts',
		],
		rules: {
			'header/header': [
				2,
	...
	{
		files: [
			'src/vs/workbench/contrib/becoder/**/beCoderNewTabInput*.ts',
		],
		rules: {
			'header/header': [
				2,
	...
	// Additional extension strictness rules
	{
		files: [
			...
			'extensions/mermaid-markdown-features/preview-src/diagram-preview/**/*.ts',
		...
		languageOptions: {
			...
			parserOptions: {
				project: [
					...
					'extensions/mermaid-markdown-features/preview-src/diagram-preview/tsconfig.json',
