...
(function registerConfiguration(): void {
	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'workbench.panel.defaultLocation': {
				...
				'default': 'bottom',
				'description': localize('panelDefaultLocation', "Controls the default location of the panel (Terminal, Output, Problems) in a new workspace. It can either show at the bottom, top, right, or left of the editor area."),
			},
			...
			[LayoutSettings.MODERN_UI]: {
				...
				'default': false,
				'tags': ['experimental'],
				'description': localize('modernUI', "Controls whether the experimental Modern UI Update is enabled. When on, the side bars and bottom panel use refreshed workbench styles."),
	...
	windowTitleDescription += '\n- ' + [
		...
		localize('rootName', "`${rootName}`: name of the workspace with an optional workspace indicator (e.g. myFolder or myWorkspace (Workspace))."),
		localize('rootNameShort', "`${rootNameShort}`: shortened name of the workspace without suffixes (e.g. myFolder or myWorkspace)."),
