...
configurationRegistry.registerConfiguration({
	...
	properties: {
		[multiSelectModifierSettingKey]: {
			...
			}, "The modifier to be used to add an item in trees and lists to a multi-selection with the mouse (for example in Explorer and Open Editors). The 'Open to Side' mouse gestures - if supported - will adapt such that they do not conflict with the multiselect modifier.")
		},
		[openModeSettingKey]: {
			type: 'string',
