...
// Shared chat types remain available to core services, but BeCoder does
// not register the Chat/agent configuration surface in the OI distribution.
if (globalThis.location.protocol === 'vscode-oi-chat-settings:') {
