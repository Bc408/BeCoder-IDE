...
当前 BeCoder 产品版本为 **1.0.0**。BeCoder 源自 **Code - OSS 1.130**，并保留 **1.130.0** 扩展 API 兼容版本。BeCoder 是独立产品，不与系统中安装的 Visual Studio Code 共用产品数据或配置。
...
BeCoder 通过面向 64 位 Windows 10 及更高版本的 `BeCoderSetup-x64-1.0.0.exe` 发行。
...
当前关闭了应用更新功能和相关设置，BeCoder 不会在应用内检查更新。新版本可从 [GitHub Releases](https://github.com/Bc408/BeCoder/releases) 获取，并由用户明确执行替换安装。

## 许可证与源码

BeCoder 源码位于 [github.com/Bc408/BeCoder](https://github.com/Bc408/BeCoder)。
...
产品问题或安全问题请通过 [GitHub Issues](https://github.com/Bc408/BeCoder/issues) 报告。
