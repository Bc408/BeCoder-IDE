...
import './media/testResultStackWidget.css';
...
class FrameCodeRenderer extends AbstractFrameRenderer<IStackTemplateData> {
	...
	protected override finishRenderTemplate(data: IAbstractFrameRendererTemplateData): IStackTemplateData {
		...
		const toolbar = data.templateStore.add(this.instantiationService.createInstance(MenuWorkbenchToolBar, data.elements.actions, MenuId.TestCallStack, {
