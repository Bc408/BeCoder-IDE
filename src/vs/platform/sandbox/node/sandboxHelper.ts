...
// BeCoder does not ship Agent/Chat or the MXC runtime. Keep every Windows
...
const beCoderWindowsMxcSandboxEnabled = false;
...
export class SandboxHelperService implements ISandboxHelperService {
	...
	async getWindowsMxcFilesystemPolicy(): Promise<IWindowsMxcFilesystemPolicy | undefined> {
		if (!isWindows || !beCoderWindowsMxcSandboxEnabled) {
			return undefined;
		}
