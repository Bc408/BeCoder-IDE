...
export class MainThreadDocumentsAndEditors implements IMainThreadEditorLocator {
	...
	constructor(
		...
		this._mainThreadDocuments = this._toDispose.add(new MainThreadDocuments(extHostContext, this._modelService, this._textFileService, fileService, textModelResolverService, uriIdentityService, workingCopyFileService, pathService));
